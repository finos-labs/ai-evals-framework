# AI Evaluation and Benchmarking Framework Contribution and Governance Policies

This document describes the contribution process and governance policies of the FINOS AI Evaluation and Benchmarking Framework project.
...
AI Evaluation and Benchmarking Framework is [Apache 2.0 licensed](https://www.apache.org/licenses/LICENSE-2.0) and accepts contributions via Git pull requests.

This repository is a [FINOS Labs](https://www.finos.org/blog/updated-finos-project-lifecycle) project. Contribution compliance is **DCO** (signed commits).
...
2. If there isn't already a relevant issue, create one describing your contribution and the problem you're trying to solve. For new evaluation scenarios, use the [Financial Agent Use Case](https://github.com/finos-labs/ai-evals-framework/issues/new?template=Use_case.yml) issue template.
